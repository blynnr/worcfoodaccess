...
This mapping exercise shifts the focus from the end result of environmental (and along similar lines, food) injustice to those who help perpetuate it through residential segregation and settlement patterns in the urban design of cities. MassGIS's Environmental Justice Populations data is used to demonstrate how this alternative perspective can be made concrete. 
