...
*(1) why are variable names now being cutoff in eijpop? this is not good because will produce errors downstream of var names being called *(2) need to fix this to figure out how many wap areas we have... maybe need to use more stringent selection criteria to choose these? consult metrics Shelton used, see if you can find your own (3) REMEMBER THIS IS JUST A FUNCTIONAL ANSWER TO A SIMPLE QUESTION, A STIMULATION, NOT A SCIENTIFICALLY RIOURIOUS MAP. TSHELTON WROTE A WHOLE PAPER DOING THAT, SO YOU DON'T HAVE TO DO IT PERFECTLY ON TOP OF THE 5 OTHER THINGS YOU'RE ALREADY DOING
...
# fix legend lables
# get rid of "color" and "fill" sections in legend to have everything grouped together
# get rid of grey background outside of worcester? - how did this happen on other plots?
