...
Try to connect property and ownership points
```{r}
# take sampling of food desert to wap ownership points
set.seed(1)
own_sample <- own_fdeij %>% sample_n(6)

# st_linestring or st_cast points to linestring
